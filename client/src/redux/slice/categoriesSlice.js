...
export const getCategory = createAsyncThunk("getCategory", async () => {
    const response = await axios.get("http://localhost:9171/categories")
    return response.data
})
export const deleteCategory = createAsyncThunk("deleteCategory", async (id) => {
    await axios.delete(`http://localhost:9171/categories/${id}`)
    return id
})

export const addCategory = createAsyncThunk("addCategory", async (data) => {
    await axios.post(`http://localhost:9171/categories`, data)
    return data
})
export const updateCategory = createAsyncThunk("updateCategory", async (cate) => {
    await axios.put(`http://localhost:9171/categories/${cate.id}`, data)
    return data
})
